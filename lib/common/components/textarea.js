...
exports.CustomTextareaElement = void 0;
const wrapper_1 = require("./wrapper");
class CustomTextareaElement extends HTMLTextAreaElement {
    constructor(state, allowWatch = false, shadow_) {
        super();
        this.shadow_ = shadow_;
        this.state_ = {};
        this.wrapper_ = new wrapper_1.CustomElementWrapper(this, this.state_, state, allowWatch, shadow_);
...
exports.CustomTextareaElement = CustomTextareaElement;
