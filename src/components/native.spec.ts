...
import { INativeElementAttribute } from '../types';
...
describe('NativeElement', () => {
    ...
    describe('Constructor Behavior', () => {
        it('should set template and hidden options', () => {
            ...
            const mockElement = {
                attributes: [],
                attributes_: [] as INativeElementAttribute[],
            ...
            Array.from(mockElement.attributes).forEach(({ name, value }: any) => {
    ...
    describe('GetAttributes Method', () => {
        it('should return the stored attributes array', () => {
            const mockAttributes: INativeElementAttribute[] = [
        ...
        it('should preserve attribute structure', () => {
            const testAttribute: INativeElementAttribute = { 
                name: 'test-attribute', 
                value: 'test-value' 
            };
    ...
    describe('Attribute Processing', () => {
        it('should handle various attribute types', () => {
            const testCases = [
                ...
                { name: 'custom-attr', value: '' }, // Empty value
